...
The challenge is to create a landing page for Easybank, a modern bank promoting digital banking methods. Users should be able to view the optimal layout for the site depending on their device's screen size and see hover states for all interactive elements on the page.
...
- Solution URL: [GitHub Repository](https://github.com/SartHak-0-Sach/Easybank-landing-page_frontend_project)
